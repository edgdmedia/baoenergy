    ...
    <ScrollReveal>
      ...
      <div className="relative h-[360px] flex items-center overflow-hidden">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[rgba(10,9,7,0.78)] to-[rgba(10,9,7,0.5)]" />
      ...
      >
        ...
        <h2 className="text-text-heading font-sans font-bold text-2xl md:text-[1.5rem] leading-[1.3] mt-[22px] mb-11 max-w-[780px] text-pretty">
